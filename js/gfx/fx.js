...
G.Fx = (function () {
   ...
   * 塔は世界樹ユグドラシルを登る場所なので、帯の名前は九つの世界から取っている。 */
  var BANDS = [
    { max: 5,   name: 'ミズガルズ ― 人の世の外れ', a: '#16223a', b: '#0b0e18', tint: '#2a4a3a' },
    { max: 10,  name: 'ニヴルヘイム ― 霧と氷',     a: '#132a3d', b: '#0a0f1a', tint: '#1f4a5e' },
    { max: 15,  name: 'ムスペルヘイム ― 炎',       a: '#2a1728', b: '#100a16', tint: '#5e2440' },
    { max: 20,  name: 'ヨトゥンヘイム ― 巨人の国', a: '#1b2a2a', b: '#0a1010', tint: '#2a5a4a' },
    { max: 25,  name: 'アースガルズ ― 神々の座',   a: '#1b1636', b: '#0a0912', tint: '#3a2a6a' },
    { max: 999, name: 'ラグナロク ― 終わりのあと', a: '#241033', b: '#08060f', tint: '#5a1f66' }
  ];
